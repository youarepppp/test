!function (a) {
    ...
    var c = {
        ...
        options: {
            ...
            lang: "en-US",
            direction: null,
            toolbar: [["style", ["style"]], ["font", ["bold", "italic", "underline", "clear"]], ["fontname", ["fontname"]], ["color", ["color"]], ["para", ["ul", "ol", "paragraph"]], ["height", ["height"]], ["table", ["table"]], ["insert", ["link", "picture", "video","test1"]], ["view", ["fullscreen", "codeview"]], ["help", ["help"]]],
            oninit: null,
            onfocus: null,
            onblur: null,
            onenter: null,
        ...
        },this.showTestDialog = function (c, d, e) {
            return a.Deferred(function (a) {
               // alert(77777);
               // alert(d.find(".note-test1-dialog"));
                var f = d.find(".note-test1-dialog"), g = f.find(".note-test1-text"), h = f.find(".note-test1-url"), i = f.find(".note-test1-btn"), j = f.find("input[type=checkbox]");
                alert(f.text());
                alert(g.text());
                alert(h.text());
                alert(i.text());
        ...
        var d = new m, g = new o, j = new p, k = new q, l = new r, s = function (b) {
            ...
            if (h.length > 0) {
                ...
                } else if ("showTestDialog" === m) {
                    u.focus();
                    var A = d.getLinkInfo();
                    d.saveRange(u), l.showTestDialog(u, r, A).then(function (a, b) {
                        d.restoreRange(u), d.createLink(u, a, b)
                    })
        ...
        b = {
            ...
            test1: function (a) {
                return '<button type="button" class="btn btn-default btn-sm btn-small" title="test1" data-event="showTestDialog" tabindex="-1"><i class="fa fa-link icon-link"></i></button>'
            },
            video: function (a) {
        ...
        g = function (a, b) {
            var d = function () {
                ...
                return '<div class="note-link-dialog modal" aria-hidden="false"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">&times;</button><h4>' + a.link.insert + '</h4></div><div class="modal-body"><div class="row-fluid"><div class="form-group"><label>' + a.link.textToDisplay + '</label><input class="note-link-text form-control span12" disabled type="text" /></div><div class="form-group"><label>' + a.link.url + '</label><input class="note-link-url form-control span12" type="text" /></div>' + (b.disableLinkTarget ? "" : '<div class="checkbox"><label><input type="checkbox" checked> ' + a.link.openInNewWindow + "</label></div>") + '</div></div><div class="modal-footer"><button href="#" class="btn btn-primary note-link-btn disabled" disabled="disabled">' + a.link.insert + "</button></div></div></div></div>"
                    ...
                    return '<div class="note-test1-dialog modal" aria-hidden="false"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">&times;</button><h4>' + a.test1.insert + '</h4></div><div class="modal-body"><div class="row-fluid"><div class="form-group"><label>' + a.test1.textToDisplay + '</label><input class="note-test1-text form-control span12" disabled type="text" /></div><div class="form-group"><label>' + a.test1.url + '</label><input class="note-test1-url form-control span12" type="text" /></div>' + (b.disableLinkTarget ? "" : '<div class="checkbox"><label><input type="checkbox" checked> ' + a.test1.openInNewWindow + "</label></div>") + '</div></div><div class="modal-footer"><button href="#" class="btn btn-primary note-test1-btn disabled" disabled="disabled">' + a.test1.insert + "</button></div></div></div></div>"
                },
                f = function () {
            ...
            return '<div class="note-dialog">' + d() + e()+y() + f() + g()  +"</div>"
        }, h = function () {
